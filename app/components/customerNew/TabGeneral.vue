...
<template>
    <div class="flex flex-col lg:flex-row gap-10">
        ...
        <div class="w-full lg:w-[280px] shrink-0 space-y-6">
            <!-- Photo Upload Area -->
            <div class="group relative border-2 border-dashed border-gray-200 hover:border-blue-400 rounded-3xl p-8 flex flex-col items-center justify-center text-center gap-4 bg-white/50 hover:bg-blue-50/30 transition-all duration-300 h-[240px] shadow-sm hover:shadow-md cursor-pointer overflow-hidden">
                ...
                <div class="w-16 h-16 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-100 transition-all duration-300 relative z-10 shadow-sm">
                    <UIcon name="i-heroicons-camera" class="w-8 h-8" />
                </div>
                <div class="relative z-10">
                    <div class="font-bold text-gray-700 group-hover:text-blue-700 transition-colors">อัปโหลดรูปโปรไฟล์</div>
            ...
            <div class="bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl p-6 border border-slate-700 shadow-xl shadow-slate-900/10 relative overflow-hidden group">
                ...
                <div class="text-xs text-slate-400 mb-1 font-medium tracking-wide">รหัสลูกค้า (Customer ID)</div>
        ...
        <div class="flex-1 space-y-8">
            ...
            <div class="space-y-3 pt-6">
                <div class="group bg-white ring-1 ring-gray-200 hover:ring-blue-300 rounded-2xl transition-all duration-200 hover:shadow-md overflow-hidden">
                    <div class="flex items-center justify-between p-4 cursor-pointer text-gray-700 hover:bg-slate-50/50">
                        <div class="flex items-center font-bold">
                            <div class="w-8 h-8 rounded-full bg-blue-50 text-blue-500 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                                <UIcon name="i-heroicons-globe-alt" class="w-4 h-4" />
                            </div>
                            ข้อมูลภาษาอังกฤษ / Passport
                            <span class="text-xs font-medium text-slate-400 ml-2 bg-slate-100 px-2 py-0.5 rounded-md hidden sm:inline-block">ลูกค้าต่างชาติ</span>
                        </div>
                        <div class="flex items-center text-sm font-medium text-blue-600 bg-blue-50 px-3 py-1 rounded-full group-hover:bg-blue-100 transition-colors">
                            ขยาย
                ...
                <div class="group bg-white ring-1 ring-gray-200 hover:ring-indigo-300 rounded-2xl transition-all duration-200 hover:shadow-md overflow-hidden">
                    <div class="flex items-center justify-between p-4 cursor-pointer text-gray-700 hover:bg-slate-50/50">
                        <div class="flex items-center font-bold">
                            <div class="w-8 h-8 rounded-full bg-indigo-50 text-indigo-500 flex items-center justify-center mr-3 group-hover:scale-110 transition-transform">
                                <UIcon name="i-heroicons-building-office-2" class="w-4 h-4" />
                            </div>
                            ข้อมูลบริษัท / ที่ทำงาน
                        </div>
                        <div class="flex items-center text-sm font-medium text-indigo-600 bg-indigo-50 px-3 py-1 rounded-full group-hover:bg-indigo-100 transition-colors">
                            ขยาย
                            <UIcon name="i-heroicons-chevron-down" class="w-4 h-4 ml-1" />
                        </div>
                    </div>
