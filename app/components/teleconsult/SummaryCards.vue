    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-2xl p-5 text-white shadow-lg shadow-indigo-500/20 relative overflow-hidden">
            ...
            <div class="flex items-center gap-2 mb-3 relative z-10">
                ...
                <span class="text-xs font-bold text-white/90">กำลังตรวจอยู่</span>
            </div>
            ...
            <div class="flex items-center gap-3 relative z-10">
                <div class="flex -space-x-2">
                    <div class="w-6 h-6 rounded-full bg-white text-indigo-600 flex items-center justify-center text-[10px] font-bold ring-2 ring-indigo-500">ปท</div>
                    <div class="w-6 h-6 rounded-full bg-orange-100 text-orange-600 flex items-center justify-center text-[10px] font-bold ring-2 ring-indigo-500">WS</div>
                </div>
        ...
        <div class="bg-white rounded-2xl p-5 ring-1 ring-gray-100 shadow-sm flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="text-[11px] font-bold text-emerald-500">{{ summary.completedTrend }}</div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl p-5 ring-1 ring-gray-100 shadow-sm flex flex-col justify-between">
            ...
            <div>
                ...
                <div class="text-[11px] font-medium text-gray-400">เฉลี่ย ฿{{ formatNumber(summary.revenueAvg) }}/เซสชัน</div>
            </div>
        </div>
    </div>
</template>
